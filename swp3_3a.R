...
#intent to buy 
sum(group3_p$IntentToBuy) #21
sum(group3_p$IntentToBuy[(group3_p$Age=="2" | group3_p$Age=="3" | group3_p$Age=="4") & group3_p$Gender=="1"]) #6 / 5 ohne age Gruppe 4
sum(group3_p$IntentToBuy[(group3_p$Age=="2" | group3_p$Age=="3" | group3_p$Age=="4") & group3_p$Gender=="2"]) #12 / 10 ohne age Gruppe 4

sum(group2_p$IntentToBuy) #133 --> marketing peeps sollten sich auf dieses Involvement level einstellen, how to increase the involvement (maybe thru creating a more emotional ad?)
sum(group2_p$IntentToBuy[group2_p$Age=="2" | group2_p$Age=="3"]) #119 -> es sind voarllem 19-29 age - marketing auf diese Zielgruppe
sum(group2_p$IntentToBuy[(group2_p$Age=="2" | group2_p$Age=="3") & group2_p$Gender=="1"]) #57
sum(group2_p$IntentToBuy[(group2_p$Age=="2" | group2_p$Age=="3") & group2_p$Gender=="2"]) #62


sum(group1_p$IntentToBuy) #20
sum(group1_p$IntentToBuy[(group1_p$Age=="2" | group1_p$Age=="3" | group1_p$Age=="4") & group1_p$Gender=="1"])  #9 / 7 ohne age gruppe 4
sum(group1_p$IntentToBuy[(group1_p$Age=="2" | group1_p$Age=="3" | group1_p$Age=="4") & group1_p$Gender=="2"])  #10 / 10 ohne age Gruppe 4
