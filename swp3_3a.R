...
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="1"]) #51 Leute wollen neue 
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="0"]) 
...
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="1" & data$Gender=="1"]) #19 von den 
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="1" & data$Gender=="2"]) #32 von den

sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="0"]) #100
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="0" & data$Gender=="1"]) 
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") & data$Own=="0" & data$Gender=="2"])

sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") &  data$Gender=="1"]) #69 women 
sum(data$IntentToBuy[(data$Age=="2"|data$Age=="3") &  data$Gender=="2"]) #82 men 
...
g3.buy <- sum(group3$IntentToBuy[group3$Age=="2"|group3$Age=="3"]) #36 from group 3 wanna buy
g3.buy
g2.buy <- sum(group2$IntentToBuy[group2$Age=="2"|group2$Age=="3"]) #71 from group 2 wanna buy
g2.buy 
g1.buy <- sum(group1$IntentToBuy[group1$Age=="2"|group1$Age=="3"]) #44 from g1 
g1.buy

df.gender.g3 <-  data.frame(gender = c("female", "male"), ITB3= c(sum(group3$IntentToBuy[group3$Gender=="1" & (group3$Age=="2"|group3$Age=="3")]),sum(group3$IntentToBuy[group3$Gender=="2" & (group3$Age=="2"|group3$Age=="3")])))
df.gender.g3

df.gender.g2 <-  data.frame(gender = c("female", "male"), ITB2= c(sum(group2$IntentToBuy[group2$Gender=="1" & (group2$Age=="2"|group2$Age=="3")]),sum(group2$IntentToBuy[group2$Gender=="2" & (group2$Age=="2"|group2$Age=="3")])))
df.gender.g2

df.gender.g1 <-  data.frame(gender = c("female", "male"), ITB1= c(sum(group1$IntentToBuy[group1$Gender=="1" & (group1$Age=="2"|group1$Age=="3")]),sum(group1$IntentToBuy[group1$Gender=="2" & (group1$Age=="2"|group1$Age=="3")])))
df.gender.g1
